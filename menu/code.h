            ...
            {"language +", {
                ...
                {"rust +", {{"rustc +", {{"show help page or rustc#rustc --help#"},
                            ...
                            {"cargo +", {{"show help page#cargo --help#"},
                                         ...
                                         {"create project structured as a lib#cargo new --lib rustlib#"},
                                         {"compile the proejct in release mode (for better product performance)#cargo build --release#"},
                                         {"add dependencies & update cargo.toml#cargo add ${module_name}#"},
                                         {"remove dependencies & update cargo.toml#cargo remove ${module_name}#"},
                                         {"cleanup the target folder (all artifacts)#cargo clean#"},
                                         {"cleanup only the release folder#cargo clean --release#"},
                                         {"cleanup only the doc in target folder#cargo clean --doc#"}}}}},
