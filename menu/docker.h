    ...
    docker_ptr->submenu = {
        {"docker +", {
            ...
            {"port +", {{"list port mapping info of a container#docker port ${containerid}#"},
                        {"designated port mapping in/out of the container#docker run -it --rm -p ${ext_port}:${in_port} ${img} ${cmd}#"},
                        {"port mapping with dynamic port allocation for external#docker run -it --rm -p ${in_port} ${img} ${cmd}#"},
                        {"tcp port mapping with dynamic port allocation for external#docker run -it --rm -p ${in_port}/tcp ${img} ${cmd}#"},
                        {"udp port mapping with dynamic port allocation for external#docker run -it --rm -p ${in_port}/udp ${img} ${cmd}#"}}},
