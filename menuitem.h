...
MenuItem* initdata(){
    ...
    menu_ptr->submenu = {
        ...
        {"revision control +", {
            {"git +", {{"git init +", {{"*init git repo in current dir#git init#gitinit"},
                       ...
                       {"git remote +", {{"list configured remote name:url for cur repo#git remote -v#"},
                                         {"set remote name:url for local repo (replace if existed)#git remote set-url ${remote_name} ${remote_repo_url.git}#"},
                                         {"set remote name:url for local repo (dryrun if existed)#git remote add ${remote_name} ${remote_repo_url.git}#"}}},
        ...
        {"docker +", {{"login +", {{"*login user/pwd to dockerhub#docker login#dockerlogin"},
                      ...
                      {"system +", {{"show cmd manual#docker system --help#"},
                      ...
                      {"stats +", {{"show cmd manual#docker stats --help#"},
