...
MenuItem* initdata(){
    ...
    menu_ptr->submenu = {
        ...
        {"revision control +", {
            {"git +", {{"git init +", {{"*init git repo in current dir#git init#gitinit"},
                       ...
                       {"commit +", {{"commit changes merging into the HEAD commit, modify the commit msg#git commit --amend#"},
                                     ...
                                     {"show only the filename for certain commit id#git diff-tree --no-commit-id --name-only ${commit_id} -r#"},
                                     {"show commitid filename for certain commit#git diff-tree --name-only ${commit_id} -r#"}}},
        ...
        {"ethtool +", {{"ethtool: query network driver/hardware settings#https://man7.org/linux/man-pages/man8/ethtool.8.html#"},
                       {"show network receive/transmit statistics of a nic#ethtool -S ${nic}#"},
