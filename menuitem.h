    ...
    menu_ptr->submenu = {
        ...
        {"revision control +", {
            {"git +", {{"git init +", {{"*init git repo in current dir#git init#gitinit"},
                       ...
                       {"git clone +", {{"retrive repo from remote url#git clone https://github.com/twistfatezz/ISEnet.git#"}}},
                       ...
                       {"git push +", {{"forcibly overwrite remote with local (share the same branch name)#git push -f ${remote} ${branch}#"}, 
