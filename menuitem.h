    ...
    menu_ptr->submenu = {
        ...
        {"docker +", {{"login +", {{"*login user/pwd to dockerhub#docker login#dockerlogin"},
                      ...
                      {"image +", {{"show all images#docker images#"},
                                   ...
                                   {"*docker multi-stage build#see desc/dockerfile for details#docker multistage build"}}},
                      ...
                      {"files +", {{"copy files from container to host#docker cp ${container_id}:${absolute_path} ${hostdir}#"},
                                   {"copy files from host to container#docker cp ${hostdir} ${container_id}:${absolute_path}#"}}}}},
