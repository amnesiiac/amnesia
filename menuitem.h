    ...
    menu_ptr->submenu = {
        ...
        {"docker +", {{"login +", {{"*login user/pwd to dockerhub#docker login#dockerlogin"},
                      ...
                      {"image +", {{"show all images#docker images#"},
                                   ...
                                   {"export docke image to local tar file#docker save -o ${output}.tar ${image}:latest#"},
        ...
        {"code +", {{"language +", {{"golang +", {{"show go help page#go --help#"},
                    ...
                    {"compilation +", {{"elf +", {{"search for symbol from binary by inspecting its elf format#readelf -s --wide ${binary} | grep ${symbolname}#"}}}}}}},
